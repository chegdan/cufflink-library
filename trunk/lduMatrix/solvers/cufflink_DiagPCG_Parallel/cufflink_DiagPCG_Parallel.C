...
#include "cufflink_DiagPCG_Parallel.H"
...
extern "C" void CFL_DiagPCG_Parallel(cusp_equation_system *,  OFSolverPerformance *, const cpuInterfaces *);//extern function in CUDA that solves the equation system

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(cufflink_DiagPCG_Parallel, 0);

    lduSolver::addsymMatrixConstructorToTable<cufflink_DiagPCG_Parallel>
        addcufflink_DiagPCG_ParallelSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::cufflink_DiagPCG_Parallel::cufflink_DiagPCG_Parallel
(
