...
extern "C" void CFL_SmAPCG(cusp_equation_system *CES,  OFSolverPerformance *OFSP);//extern function in CUDA that solves the equation system

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(cufflink_SmAPCG, 0);

    lduSolver::addsymMatrixConstructorToTable<cufflink_SmAPCG>
        addcufflink_SmAPCGSymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::cufflink_SmAPCG::cufflink_SmAPCG
(
...
Foam::lduSolverPerformance Foam::cufflink_SmAPCG::solve
(
    scalarField& x,
    const scalarField& b,
...
) const
{
 ...
 // --- Setup class containing solver performance data
    lduSolverPerformance solverPerf("cufflink_SmAPCG",fieldName());
	...
	CFL_SmAPCG(&CES, &OFSP);//call the CUDA code to solve the system
