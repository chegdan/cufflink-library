...
extern "C" void CFL_SmAPCG_Parallel(cusp_equation_system *CES,  OFSolverPerformance *OFSP, const cpuInterfaces *OFInterfaces){
	...
	if(0 == CFLInterfaces.myThreadNumber && OFSP->debugCusp){std::cout<<"   Using Cusp_SmA preconditioner\n";}
