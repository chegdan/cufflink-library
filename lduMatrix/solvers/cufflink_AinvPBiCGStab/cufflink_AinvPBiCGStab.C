...
#include "cufflink_AinvPBiCGStab.H"
...
namespace Foam
{
    defineTypeNameAndDebug(cufflink_AinvPBiCGStab, 0);

    lduSolver::addasymMatrixConstructorToTable<cufflink_AinvPBiCGStab>
        addcufflink_AinvPBiCGStabAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::cufflink_AinvPBiCGStab::cufflink_AinvPBiCGStab
(
...
Foam::lduSolverPerformance Foam::cufflink_AinvPBiCGStab::solve
(
    scalarField& x,
    const scalarField& b,
...
//end COO, X, b initialize and fill
	...
	CFL_AinvPBiCGStab(&CES, &OFSP);//call the CUDA code to solve the system
